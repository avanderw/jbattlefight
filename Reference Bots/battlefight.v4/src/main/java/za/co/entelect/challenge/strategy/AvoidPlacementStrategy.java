...
public class AvoidPlacementStrategy {
    ...
    public static PlaceShipCommand placeShips(GameState state) {
        ...
        placements.add(new Placement(state).avoid(ShipType.Carrier));
        placements.add(new Placement(state).avoid(ShipType.Battleship));
        placements.add(new Placement(state).avoid(ShipType.Cruiser));
        placements.add(new Placement(state).avoid(ShipType.Submarine));
