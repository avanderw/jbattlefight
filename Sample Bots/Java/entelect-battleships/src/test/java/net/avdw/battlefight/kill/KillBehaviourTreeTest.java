...
public class KillBehaviourTreeTest {
    ...
    public void testUnfinishedKillCell() {
        ...
        map[1][2] = emptyCell;
        map[0][1] = emptyCell;
        assertTrue("Surrounded by empty cells is head and tail.", KillBehaviourTree.unfinishedKillCell(map, shotCell));

        map[2][1] = shotCell;
        assertTrue("Only shot above is unfinished.", KillBehaviourTree.unfinishedKillCell(map, shotCell));
        map[0][1] = shotCell;
        assertFalse("Shot above and below is finished.", KillBehaviourTree.unfinishedKillCell(map, shotCell));
        map[0][1] = map[2][1] = emptyCell;

        map[1][0] = shotCell;
        assertTrue("Only shot left is unfinished.", KillBehaviourTree.unfinishedKillCell(map, shotCell));
        map[1][2] = shotCell;
        assertFalse("Shot left and right is finished.", KillBehaviourTree.unfinishedKillCell(map, shotCell));
        map[1][0] = map[1][2] = emptyCell;

        map[2][1] = missCell;
        assertTrue("Only missed above is unfinished.", KillBehaviourTree.unfinishedKillCell(map, shotCell));
        map[0][1] = map[2][1] = emptyCell;

        map[1][0] = missCell;
        assertTrue("Only missed left is unfinished.", KillBehaviourTree.unfinishedKillCell(map, shotCell));
        map[1][0] = map[1][2] = emptyCell;

        map[2][1] = missCell;
        map[0][1] = shotCell;
        assertFalse("Missed above and shot below is finished.", KillBehaviourTree.unfinishedKillCell(map, shotCell));
        map[0][1] = map[2][1] = emptyCell;

        map[1][0] = shotCell;
        map[1][2] = missCell;
        assertFalse("Shot left and missed right is finished.", KillBehaviourTree.unfinishedKillCell(map, shotCell));
        map[1][0] = map[1][2] = emptyCell;

        map[2][1] = shotCell;
        map[1][2] = shotCell;
        assertTrue("Shot above and right is unfinished.", KillBehaviourTree.unfinishedKillCell(map, shotCell));
